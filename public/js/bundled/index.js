...
},{"./login":"7yHem","./leaflet":"xvuTT","regenerator-runtime/runtime":"dXNgZ","./updateSettings":"l3cGY","./stripe":"10tSC"}],"7yHem":[function(require,module,exports) {
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (res.data.status === "success") (0, _alerts.showAlert)("success", `${type === "password" ? "Password updated successfully" : "Data updated succesfully"}`);
    } catch (err) {
        (0, _alerts.showAlert)("error", err.response.data.message);
        console.log(err);
    }
...
const bookTour = async (tourId)=>{
    const stripe = Stripe("pk_test_51NIflXBw25ZdTWsgCL6kHtXkzUlUVhNJdQUWfg3de6KuXPG5vDAo73suNqFGiVwNNMfXJK56s6cRE6LtkKshkmyn00xbkXGHbL");
    try {
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alerts":"6Mcnf"}]},["722o8","f2QDv"], "f2QDv", "parcelRequire11c7")
